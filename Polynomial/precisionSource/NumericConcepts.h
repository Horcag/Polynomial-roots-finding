 ...
 *
 * Необходим для generic-кода, работающего с epsilon, infinity и т.д.
 */
template <typename T>
...
// Примечание: этот концепт проверяется отложенно, т.к. abs_val может быть
// определён позже через перегрузки.
