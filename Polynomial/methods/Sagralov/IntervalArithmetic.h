...
public:
  ...
  explicit Interval(T value)
      : lower(value), upper(value) {} // точечный интервал
  ...
  // Все операции выполняются так, чтобы результат гарантированно содержал
  // истинное значение результата операции над реальными числами.
